...
- **Key dates ahead:** **Fri 7/3 market CLOSED** (July 4 observed; reopens Mon 7/6); **Mon 7/7 SPCX joins the
  ...
  BAC sold); **late July** big-tech earnings (TSLA 7/22, META 7/29, AAPL/AMZN 7/30 = AI-capex read-through); **Jul
  28–29 FOMC** (~97% hold, no dot plot — first meeting since the soft-jobs reset); **Tue Sep 8 IONQ investor day**
  (forward quantum catalyst — calendared).
