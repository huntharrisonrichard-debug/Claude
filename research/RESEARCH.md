...
- **As of:** 2026-07-07 (Research Agent — Tue pre-market; market open; live web data)
- **Regime:** **THE "GREAT ROTATION" (VALUE/SMALL-CAP/ENERGY) IS THE DOMINANT TAPE — THE SLEEVE'S ~100% AI BETA IS ON THE WRONG SIDE.**
  Two corrections + a fresh geo shock this run. **🛑 BENCHMARK ERROR CAUGHT:** the 7/6 journal recorded the S&P FLAT at
  7,483.24 — it actually **closed 7,537.43 (+0.72%), Dow record 53,055.91, Nasdaq +1.12%** on revived AI optimism
  (Foxconn sales). **S&P since inception = +1.19%**, not +0.46% → fix `benchmark/performance.csv` and the 7/6 close row.
  **🔻 THE 7/6 TECH RALLY IS ALREADY REVERSING:** pre-mkt 7/7 Nasdaq-100 futures −1.16%, **MU −5.6%, NVDA −2.1%** while
  Dow +0.26% / Russell +0.37% — semis are the rotation's funding source. **Lesson (repeat): a one-day tech bounce is NOT
  a rotation reversal** — my own 7/6 "value→tech reversing" read was a half-day head-fake. Structurally the **Great
  Rotation is intact: Russell 2000 +12% YTD vs S&P +1.5%**, energy/industrials/defensive leading; the book (CEG ~30% /
  NVDA ~24% / VST ~12% / IONQ ~6% + ~28% cash) badly lacks non-AI breadth. **🛢️ HORMUZ RE-ESCALATION (new & material):**
  an **Iranian missile struck the Qatari LNG tanker _Al Rekayyat_ exiting Hormuz early 7/7**, testing the US-Iran deal
  (Euro gas +4.5%, oil 1-wk high ~$69, gold ~$4,150) → **fires the §6 XOM re-examine trigger**; energy re-elevated (also
  the rotation winner, XLE +23% YTD) as the sleeve's cleanest breadth fix — **watch-the-uptrend, not a chase** (6/22
  whipsaw; ⚠️ XOM wash-sale, sold 6/18). **🏦 FED — honest re-frame:** June dots HAWKISH (9 see ≥1 hike, PCE 3.6% y/e),
  Warsh scrapped forward guidance; the soft July-2 jobs drove *market* pricing to a hold but the Fed itself isn't dovish
  — June minutes ~7/8, FOMC 7/28-29, **rate risk two-sided**. **🎯 CEG rebounded +2.77% to $245.87** off its $240.27 low
  — thesis intact, AI-side #1 add, earnings 7/30. **🆕 PLTR ran to $133** (past the ~$126 entry on the 7/1 NVDA-partnership
  pop) → downgraded to a pullback-watch (~$126–128). **⚛️ Quantum concentrating into IBM:** IONQ ~$50.75, RGTI ~$18.09 —
  hold IONQ small into Sep 8. **💰 Open item:** owner sold BAC+WMT (7/1) → ~$226 freed sleeve cash, earmarked pending
  owner steer. **✅ Operational:** Webull connector = the standing risk (3 straight failures 7/6; live only ~2 of ~13
  runs) — reconnect early.
- **Key dates ahead:** **~Wed 7/8 June FOMC minutes** (hike-bias tone; two-sided rate risk); **Thu 7/9 PEP earnings**
  (staples read); **Fri 7/10 DAL earnings** (travel/consumer); **CEG lockup digestion** (a hold in the $240s = add, not
  a thesis break — rebounded to $245.87); **~Tue 7/14 Q2 bank earnings begin** (JPM/Citi/GS = read-only, BAC sold);
  **late July** big-tech earnings (TSLA 7/22, META 7/29, AAPL/AMZN 7/30 = AI-capex read-through); **CEG Q2 7/30**
  (next sleeve catalyst); **Jul 28–29 FOMC** (no dot plot); **XOM Q2 ~7/31** (energy candidate; verify date);
  **Tue Sep 8 IONQ investor day** (calendared).

## S&P 500 reference
- **Inception baseline level:** 7,449 (close, 2026-06-12) — the line we must beat.
- **Latest level / date:** **7,537.43 / 2026-07-06 close (+1.19% since inception)** — ⚠️ **CORRECTS the 7/6 journal's
  "flat 7,483.24" error.** The 7/6 tape actually RALLIED to a record (Dow 53,055.91; Nasdaq +1.12% to 26,121.16) on
  revived AI optimism (Foxconn sales). **Fix `benchmark/performance.csv` and the 7/6 close row to 7,537.43.** Sleeve
  ~−8.7% since inception (7/6 web marks) vs S&P +1.19% = **≈ −9.9% rel** (roughly unchanged — CEG's rebound to $245.87
  offset the higher index). **7/7 pre-mkt: Nasdaq-100 futures −1.16%, MU −5.6%, NVDA −2.1%** — the tech rally already
  reversing; the Great Rotation (Russell 2000 +12% YTD vs S&P +1.5%) is the dominant tape. Posture: **HOLD or add
  breadth — the ~$226 freed cash best splits toward CEG ~$246 (AI-side add) + XOM ~$136 (energy/breadth, Hormuz
  catalyst) — pending owner steer.** **Re-verify the live S&P level + sleeve marks at the open.**
...
| **XOM** ⭐RE-ELEVATED 7/7 (§6→§3 #5) | Integrated energy — the sleeve's cleanest **non-AI breadth** fix, firing on TWO tailwinds: the **7/7 Iranian missile strike on a Qatari LNG tanker in Hormuz** (fresh geo catalyst, tests the US-Iran deal) AND the **Great Rotation** (energy = XLE +23% YTD). Buy-rated, avg PT $169 (+23%); Q2 adj net income est ~$15.9B. Redomiciled to Texas 7/1 ("ExxonMobil Holdings"). | **ACTIONABLE WATCH → BUY ~$136 on oil HOLDING an up-move** (not the single headline — 6/22 whipsaw). 1 whole sh ≈ $136 (~17%, fundable). Invalidation: Hormuz strike proves a one-off / oil fades under ~$66. | M/M-H. ⚠️ **WASH-SALE:** sold 6/18 at a loss → re-buy before ~7/18 defers it. See INTEL §3 #5. |
